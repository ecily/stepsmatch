        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-start">
          <motion.div {...fadeUp(0.05)}>
            ...
            <ol className="mt-6 space-y-5">
              {[
                { step: "01", title: "Angebot definieren", text: "Kategorie, Radius, Zeitfenster, optional Wochentage & Slots." },
                { step: "02", title: "Live gehen", text: "Ausspielung an passende Personen im Umkreis — in Echtzeit." },
                { step: "03", title: "Gefunden werden", text: "Signal beim Eintritt — Zero-Search statt Werbung oder Suche." },
              ].map((s, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-3 gap-10">
          ...
          <motion.div className="rounded-2xl border border-gray-200 p-6 bg-white" {...fadeUp(0.15)}>
            ...
            <ul className="mt-3 space-y-2 text-gray-700">
              ...
              <li>• DSGVO-Konzept: <em>Privacy by Design</em>, klare Consent-Flows.</li>
            </ul>
          </motion.div>
        </div>
      </section>
