...
const pages = {
  ...
  anbieter: {
    badge: "Für Anbieter",
    title: "Erreiche Menschen, wenn dein Ort gerade relevant ist.",
    lead: "Anbieter können Hinweise oder Angebote mit Standort, Radius, Laufzeit und klaren Bedingungen veröffentlichen.",
    icon: Store,
    points: [
      "Stammdaten und Standort sauber angeben",
